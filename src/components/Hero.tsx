...
const Hero = () => {
  ...
  const socialLinks = [
    ...
    { href: "https://spotify.com", icon: <Music size={14} />, label: "Spotify" },
    { 
  ...
  return (
    <section className="min-h-[75vh] flex flex-col justify-center relative py-4" id="home">
          ...
          <div className="mb-6">
            <div className="text-5xl md:text-7xl font-black mb-4 leading-tight">
              ...
              <div className="text-2xl md:text-5xl mt-3 flex justify-center">
                You Know Me, <span className="typing-text ml-2 text-[#98AFC7] font-bold">{text}</span>
