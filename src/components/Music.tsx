...
const MusicCard: React.FC<MusicCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl font-bold mb-1 group-hover:text-portfolio-accent transition-colors duration-300">
        {title}
      </h3>
...
const Music: React.FC = () => {
  const musicData = [
    ...
    },
    {
      ...
      coverImage:
        "https://images.unsplash.com/photo-1526327760257-75f515c8cfe8?auto=format&fit=crop&q=80&w=1000",
      duration: "5:17",
      category: "Lo-Fi",
