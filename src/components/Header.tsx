        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          >
            <div className={`absolute inset-0 transition-all duration-500 rounded-full flex items-center px-1 ${theme === 'dark' ? 'bg-[#1a237e]' : 'bg-[#a3d8f4]'}`}>
              ...
              <div className={`h-10 w-10 rounded-full flex items-center justify-center transition-all duration-500 transform ${theme === 'dark' ? 'ml-auto bg-[#0d1642]' : 'ml-0 bg-[#FFD700]'}`}>
                {theme === 'dark' ? (
