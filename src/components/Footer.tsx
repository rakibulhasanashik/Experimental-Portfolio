      ...
      <div className="content-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1">
            ...
            <div className="flex flex-wrap gap-3">
              <a href="https://www.linkedin.com/in/abid-hasan-sarder" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 bg-white/10 px-3 py-1 rounded-full hover:bg-portfolio-accent/20 transition-all duration-300">
                <Linkedin size={14} />
              ...
              <a href="https://www.instagram.com/abid_hasan_sarder" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 bg-white/10 px-3 py-1 rounded-full hover:bg-portfolio-accent/20 transition-all duration-300">
                <Instagram size={14} />
                <span className="text-xs">Instagram</span>
              </a>
              <a href="https://www.facebook.com/profile.php?id=100000655539896" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 bg-white/10 px-3 py-1 rounded-full hover:bg-portfolio-accent/20 transition-all duration-300">
                <Facebook size={14} />
                <span className="text-xs">Facebook</span>
              </a>
              <a href="https://youtube.com/@Abid_Hasan_Sarder" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 bg-white/10 px-3 py-1 rounded-full hover:bg-portfolio-accent/20 transition-all duration-300">
                <Youtube size={14} />
                <span className="text-xs">YouTube</span>
              </a>
              <a href="https://open.spotify.com/artist/3WGWYAdVrm9K1uZkT9SdxA" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 bg-white/10 px-3 py-1 rounded-full hover:bg-portfolio-accent/20 transition-all duration-300">
                <Music size={14} />
              ...
              <a href="amazon.com/author/abid_hasan_sarder" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 bg-white/10 px-3 py-1 rounded-full hover:bg-portfolio-accent/20 transition-all duration-300">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 mt-4 md:mt-0">
            ...
            <button 
              onClick={scrollToTop} 
              className="absolute bottom-0 right-4 p-2 rounded-full border border-white/20 hover:bg-white/10 hover:border-portfolio-accent transition-all duration-300 group"
